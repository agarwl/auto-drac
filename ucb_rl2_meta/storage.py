...
class RolloutStorage(object):
    ...
    def meta_feed_forward_generator(self,
                               advantages,
                               num_mini_batch=None,
                               mini_batch_size=None, meta_test=False):
        num_steps, num_processes = self.rewards.size()[0:2]
        batch_size = num_processes * num_steps
        ...
        split_size = int(batch_size * (1 - self.split_ratio))
        ...
        train_sampler = BatchSampler(
            SubsetRandomSampler(train_idxs),
            mini_batch_size,
            drop_last=True)

        valid_sampler = BatchSampler(
            SubsetRandomSampler(valid_idxs),
            mini_batch_size,
            drop_last=True)
